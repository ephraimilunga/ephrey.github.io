...
},{}],"components/greettheuser.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = greetTheUser;

function greetTheUser(contryDefault, container) {
  var country_name = contryDefault.country_name,
      region_name = contryDefault.region_name,
      location = contryDefault.location;
  var time = new Date().getHours();
  var languages = location.languages.map(function (lang) {
    return "<span class=\"text_title\">".concat(lang.native, "</span>");
  }).join("");
  var elementContent = "\n    <div class=\"content_greet\">\n            <div class=\"flag_contaienr\" style=\"background: url(".concat(location.country_flag, ") center center no-repeat; background-size: cover;\"> \n                <div class=\"flag_content\">\n                    <img src=\"").concat(location.country_flag, "\">\n                </div>\n            </div>\n            <div class=\"message_content\">\n                <p class=\"greet_text\">").concat(greeting(time), " Dear from <span>").concat(country_name, "</span></p>\n                <p class=\"greet_sub_text_\">Hope everything are well in <span>").concat(region_name, "</span></p>\n                <p class=\"greet_sub_text\">Thank you for visiting <span>eWeather !</span></p>\n            </div>\n            <div class=\"local_languages\">\n                <p class=\"language_title\">Local Languages : </p>\n                <div class=\"language_container\">\n                    ").concat(languages, "\n                </div>\n            </div>\n      </div>\n  ");
...
},{}],"components/objectdata.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.weekDay = exports.fullMonths = exports.months = exports.userAutho = exports.defaultParameters = exports.languagesList = exports.unit = void 0;
// set units
var unit = {
  S: "Kelvin, m/s, mm",
  I: "F, mph, in"
...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
var _greettheuser = _interopRequireDefault(require("../components/greettheuser"));

var _objectdata = require("../components/objectdata");
...
//********************* */
// GLOBAL SELECTE
var formContainer = document.querySelector(".weather_filter_para_form"); // call the follower elment

var follower = document.querySelector(".follow_along"); // get all dropdown

var allDropdown = formContainer.querySelectorAll(".dropdown_options"); // get the close button

var closeButton = document.querySelector(".close_option"); // get the main contaienr of optional options

var mainOptionalContainer = document.querySelector(".weather_filter_para"); // get the language dropdown container

var languageDropdown = formContainer.querySelector(".language_droplist"); // get today prevision container 

var todayPrevisionContainer = document.querySelector(".today_previson"); // get tomorrow container 

var tomorrowContainer = document.querySelector(".tomorrow_block"); // get next tweo days 

var nextTwoDaysContainer = document.querySelector('.next_two_days'); // get 8 days overcast container 

var nextHeightDaysContainer = document.querySelector('.next_8days_forcast_blocks_container'); // get next 8 days title text

var nextHeightDaysText = document.querySelector('.next_8days_title_text'); // loader conatiner 

var loaderContainer = document.querySelector('.authorisation_panel_content'); // select the greeting user contaienr 

var greetContainer = document.querySelector(".greet_the_user_container"); // END GLOBAL SELECT
// GLOBAL VARIABLES
...
var thirdDay = '';
var fourthDay = '';
var moreDetails = ''; // END GLOBAL VARIABLES 
//***** HTML CONTENTS  **/
// Goodbey Message
...
function handleAuthorisation(e) {
  ...
  var elementThatHasBeenClicked = e.target;
  ...
  handleDisplay(mainWrapper); //handleHidden(authorisationMainContainer);

  loaderContainer.innerHTML = loader; // change the user authorisation status to true

  _objectdata.userAutho.status = true; // save the user to the LocalStorage for later visit.

  handleSaveUserInLocalStorage("userAutho", _objectdata.userAutho); // empty the authorisation div element
  //authorisationMainContainer.innerHTML = "";
  // save user parameter in the local storage

  handleSaveUserInLocalStorage("defaultParameters", _objectdata.defaultParameters);
  /*************************
   * HANDLE FETCH WEATHER DATA
   ***************************/

  handleFetchWeatherData(_objectdata.defaultParameters);
} // Select the Authorisation Main Conatiner


var authorisationMainContainer = document.querySelector(".authorisation_panel"); // Select DOM Helement
//Select all button within the Authorisation Panal

var allAuthorizeButton = authorisationMainContainer.querySelectorAll(".authorisation_button"); // Selected the wrapper that contains all the weather app components

var mainWrapper = document.querySelector("#wrapper"); // Check if the user has been already authorised eWeather to access its location
...
var isUserAgree = handleGetStorageData("userAutho"); // check if the local storage has a value
// if no, ask him for the authorisation
// anotherwhise display app.

if (isUserAgree === null) {
  //display the authorisation panel
  handleDisplay(authorisationMainContainer); // Add Event Listener to the Authorisation Buttons
...
var elementToFollow = document.querySelectorAll(".fa"); // add mouse hover on all elements to follow

elementToFollow.forEach(function (element) {
  return element.addEventListener("mouseover", handleFollower);
}); // this function handle the follow along effect

function handleFollower(e) {
  // get current element that is being hover
  var currentHoverElement = e.target.getBoundingClientRect(); //get the coordinate of the current hover element

  var currentElementLeft = currentHoverElement.left;
  var currentElementTop = currentHoverElement.top; // get the dimension of the current hover element

  var currentElementWidth = currentHoverElement.width;
  var currentElementHeight = currentHoverElement.height; //get window cordonate in case we add an element to the document
  ...
  follower.style.transform = "translate(".concat(coords.left, "px, ").concat(coords.top, "px)");
  follower.style.backgroundColor = "#80626263";
  follower.style.zIndex = 999; // show the follewer
...
function handleHidden(element) {
  element.classList.add("hidden"); //element.style.opacity = 0;
...
function setUserDefaultParameter() {
  var parameterData = isUserCustomParametersAvailable('defaultParameters');

  if (parameterData) {
    var language = parameterData.language,
        _unit = parameterData.unit,
        days = parameterData.days;
    _objectdata.defaultParameters.language = language;
    _objectdata.defaultParameters.unit = _unit;
    _objectdata.defaultParameters.days = days;
    translateWeekDays(parameterData, _objectdata.weekDay);
    translateWeekDays(parameterData, _objectdata.fullMonths);
  } else {
    // update the language that will be used to translate the week day
    translateWeekDays(_objectdata.defaultParameters, _objectdata.weekDay);
    translateWeekDays(_objectdata.defaultParameters, _objectdata.fullMonths);
  }
} // suggestion message
...
function typeAheadMessage(text) {
  ...
  var message; // check to see the text parameter has content

  if (!text) {
    message = "\n      <div class=\"indicatif_title\">Suggestions ...</div>\n      <div class=\"indicatif_message\">Please, type in a language.</div>";
  } else {
    message = "<div class=\"indicatif_message\">".concat(text, "</div>");
...
function getWeekDayName(target, timestamp) {
  if (target === 'day') return new Date(timestamp).getUTCDay();
  if (target === 'month') return new Date(timestamp).getUTCMonth();
  if (target === 'year') return new Date(timestamp).getUTCFullYear();
}

function translateWeekDays(defaultParametersObj, dataToTranslateObj) {
  var lang = defaultParametersObj.language;
  var words = '';

  for (var key in dataToTranslateObj) {
    words += "&text=".concat(dataToTranslateObj[key]);
  }

  var link = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20181219T222649Z.bc0bff1e7a956a89.ced4abb02cd023aad687ede450469d919261b8d3".concat(words, "&lang=").concat(lang);
...
function updateWeekDay(translatedArray, dataObjToUpdate) {
  ...
  try {
    for (var _iterator = translatedArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var key = _step.value;
      var index = translatedArray.indexOf(key);
      if (key === 'Peut') key = "May";
      index = index + 1;
...
var inputOption = formContainer.querySelectorAll("input"); // loop over inputs and add eventListener
...
function showInputDropList() {
  handleHidden(follower); // get the id value for the current input

  var currentInputId = this.getAttribute("id"); // display languages base on the user input
  ...
  if (currentInputId === "unit" || currentInputId === "days") {
    if (currentInputId === "unit") {
      var input = formContainer.querySelector("input#unit");
      input.classList.add("dropListOpen");
      input.classList.remove("dropListClose");
    } else {
      var _input = formContainer.querySelector("input#days");

      _input.classList.add("dropListOpen");

      _input.classList.remove("dropListClose");
    }
  } // close all dropdown that are not equal to the current Tab


  closeDropdown(currentInputId); // rotate the chevron on other input 

  closeChevron(this); // get the dropdown list that correspond to the current input id

  var dropDown = formContainer.querySelector(".".concat(currentInputId)); // Display the dropdown
...
function closeDropdown(currentElementId) {
  ...
  allDropdown.forEach(function (dropdown) {
    var dropDownId = dropdown.classList.contains(currentElementId); // hide dropdown if not equal to the focused input
...
function closeChevron(element) {
  if (element === 'unit' || element === "days") {
    if (element !== "unit") {
      ...
      var _input2 = formContainer.querySelector('input#days');

      _input2.classList.remove("dropListOpen");

      _input2.classList.add("dropListClose");
    }
  }
...
function fillUpInput(e) {
  ...
  var value = e.target.dataset.value; // stop the function executiion if the value is false (null or undefined)

  if (!value) return; // get the current dropdown id to help us targeting the appropriate input

  var currentDropdown = this.dataset.role; // check if the current value belong to the language dropdown
  // if yes change the language inital to the full word

  if (currentDropdown === "language") {
    value = _objectdata.languagesList.map(function (lang) {
      if (lang.initial === value) {
        // set the fault language to one that the user
        _objectdata.defaultParameters.language = lang.initial; // then return the language
  ...
  if (currentDropdown === "unit") {
    ...
    _objectdata.defaultParameters.unit = value; // set the value to the correspondig unit in full word

    value = _objectdata.unit["".concat(value)];
  } // check if the current dropdown belongs to the days dropdown


  if (currentDropdown === "days") {
    // set days of the default parameters
    _objectdata.defaultParameters.days = value;
  } // get the appropriate input that corresponding to the currentDropDown


  var input = formContainer.querySelector("input#".concat(currentDropdown)); // set the value of the target input

  input.value = value; // hide the current dropdown after setting the input value
...
window.addEventListener("click", function (e) {
  if (e.target.dataset.main === "main") {
    allDropdown.forEach(function (dropdown) {
      //close dropdown
      if (!dropdown.classList.contains("hidden")) handleHidden(dropdown); // close chevrons
...
function fillUpLanguages(value) {
  ...
  var valueLength = value.length; //if the lenght === 0 we display the suggestion text otherwise we do not
...
function matchLanguages(value) {
  ...
  return _objectdata.languagesList.filter(function (language) {
...
function handleLaguagesFilter(value) {
  ...
  var inputValue = value.toLowerCase(); // match all language base on the user input

  var mathcedLanguages = matchLanguages(inputValue); // map all mached languages and set the HTML block

  var filteredLanguages = mathcedLanguages.map(function (lang) {
    // inital the expression ton find the maching text in the languages
    var reg = new RegExp(inputValue, "gi"); // replace the input value by a customize html element

    var newLangue = lang.lang.replace(reg, "<span data-value=\"".concat(lang.initial, "\" class=\"highLight\">").concat(inputValue, "</span>")); // return and join() all matched languages element

    return "\n        <div class=\"fa initial_languages\">\n            <div data-value=\"".concat(lang.initial, "\" class=\"contents language_inital\">").concat(lang.initial, "</div>\n            <span data-value=\"").concat(lang.initial, "\" class=\"contents language_word\">").concat(newLangue, "</span>\n        </div>\n    ");
  }).join(""); // insert all mached language in the languages dropdown.

  languageDropdown.innerHTML = filteredLanguages || typeAheadMessage("Nothing was found.");
}
/*************************
/*************************
/*************************
...
function handleFetchWeatherData(_x) {
  return _handleFetchWeatherData.apply(this, arguments);
} //***************DISPLAY WEATHER INFO TO THE USER */
// this function convert a float number to an integer


function _handleFetchWeatherData() {
  _handleFetchWeatherData = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(obj) {
    var language, unit, days, weather, ipStack, userIpLink, ipStackLink, weatherLink, translateLink, ip, city, endPoint;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // destructure the default parameter object to have individual variable.
            language = obj.language, unit = obj.unit, days = obj.days; // APIs key

            weather = "65c4dd5b09024512bce943f3b65b8265";
            ipStack = "e7aaa4e45f3c7fae3204efd4c3f540a3"; // base URLs

            userIpLink = "https://api.ipify.org?format=json";
            ipStackLink = "http://api.ipstack.com/"; /// e.g : http://api.ipstack.com/YourIpAddress?access_key=YourKey

            weatherLink = "https://api.weatherbit.io/v2.0/forecast/daily?"; /// e.g : https://api.weatherbit.io/v2.0/forecast/daily?city=Raleigh,NC&key={API_KEY}

            translateLink = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20181219T222649Z.bc0bff1e7a956a89.ced4abb02cd023aad687ede450469d919261b8d3&text=Today&text=Tomorrow&text=Next 8 Days&text=Open&text=More Details&lang=".concat(language); // fetch user ip

            _context.next = 9;
            return fetch(userIpLink).then(function (result) {
              return result.json();
            }).then(function (json) {
              return json;
            }).catch(function (e) {
          ...
          case 9:
            ip = _context.sent;
            _context.next = 12;
            return fetch("".concat(ipStackLink).concat(ip.ip, "?access_key=").concat(ipStack)).then(function (result) {
              return result.json();
            }).then(function (data) {
              return data;
            }).catch(function (e) {
          ...
          case 12:
            ...
            endPoint = "".concat(weatherLink, "key=").concat(weather, "&city=").concat(city.city, "&lang=").concat(language, "&unit=").concat(unit, "&days=").concat(days);
            _context.next = 16;
            return (0, _fetchJsonp.default)(endPoint, {
              jsonpCallback: "callBack"
          ...
          case 16:
            ...
            _context.next = 19;
            return fetch(translateLink).then(function (result) {
              return result.json();
            }).then(function (translatedText) {
              return displayWeatherInfo(weatherData, translatedText, city);
            }).catch(function (e) {
...
function converNumber(number) {
  ...
  if (roundedNum > 9) return roundedNum;else if (roundedNum >= 0) return "0" + roundedNum;else if (roundedNum < 0) return roundedNum;
  ;
...
function formatDate(date, obj) {
  ...
  var monthArray = monthNumber.split('');
  ...
  var day = date.substring(8, date.length); // get the month from the date 

  var month;
  month = obj[monthNumber]; // get the year from the date

  var year = date.substring(0, 4); // return the formated date
...
function displayWeatherInfo(data, translatedText, cityObj) {
  // greet the user
  (0, _greettheuser.default)(cityObj, greetContainer); // global data object

  var city_name = data.city_name,
      country_code = data.country_code;
  moreDetails = translatedText.text[4]; // forcast data  object

  var daysData = data.data; // get fist five days

  var today = daysData[0]; // get tomorrow data

  var tomorrow = daysData[1]; // get the third day forcast

  thirdDay = daysData[2]; // get the fourth day forcast;

  fourthDay = daysData[3]; // remove first 4 days in the array data

  nextHeightDays = _toConsumableArray(daysData).splice(4); // set the tanslated text for the next 8 title text

  nextHeightDaysText.innerHTML = translatedText.text[2] + " :"; // display today weather

  todayPrevisionContainer.innerHTML = "\n    <!--start today-provision-->\n      <div class=\"today_title\">\n          <!--today title-->\n              <h1 class=\"today_title_text\">".concat(translatedText.text[0], "</h1>\n          <!--end today title-->\n      </div>\n\n      <div class=\"today_temperature\">\n          <!--today temperature -->\n              <div class=\"today_temperature_number\"><p class=\"today_number\">").concat(converNumber(today.temp), "</p></div>\n              <div class=\"today_temperature_measure\">\n                  <p class=\"today_degree_symbol\">o</p>\n                  <p class=\"today_degree_character\">").concat(_objectdata.defaultParameters.unit, "</p>\n              </div>\n          <!--end today temperature-->\n      </div>\n\n      <div class=\"today_data_and_overcast\">\n          <!--start date and overcast-->\n              <p class=\"todayDate\">").concat(formatDate(today.datetime, _objectdata.months), ", ").concat(today.weather.description, "</p>\n          <!-- end date and overcast-->\n      </div>\n\n      <div class=\"today_location_city_country\">\n          <!--start today location (city and country-->\n              <p class=\"todayCity_country\">").concat(city_name, " - ").concat(country_code, "</p>\n          <!--end today location (city and country-->\n      </div>\n\n      <div class=\"today_status_feature\">\n          <!--start today feature | min-temp | max-temp | Cloud %-->\n\n          <div class=\"today_max_temp\">\n              <!--start today min-temp -->\n              <div class=\"today_max_temp_icon\"><img src=\"https://thecreativecloud.co.za/icons/max_temp_on_yellow.svg\" alt=\"iweather\"></div>\n              <div class=\"today_max_temp_number\"><p>").concat(converNumber(today.max_temp), "</p></div>\n              <div class=\"today_max_temp_measure_and_title\">\n                  <div class=\"today_max_temp_measure_symbol_and_letter\">\n                      <p class=\"symbol\">o</p>\n                      <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                  </div>\n                  <div class=\"today_max_temp_title\"><p>Max-Temp</p></div>\n              </div>\n              <!--end today min-temp -->\n          </div>\n\n          <div class=\"today_min_temp\">\n              <!--start today min-temp -->\n              <div class=\"today_min_temp_icon\"><img src=\"https://thecreativecloud.co.za/icons/min_temp_on_yellow.svg\" alt=\"iweather\"></div>\n              <div class=\"today_min_temp_number\"><p>").concat(converNumber(today.min_temp), "</p></div>\n              <div class=\"today_min_temp_measure_and_title\">\n                  <div class=\"today_min_temp_measure_symbol_and_letter\">\n                      <p class=\"symbol\">o</p>\n                      <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                  </div>\n                  <div class=\"today_min_temp_title\"><p>Min-Temp</p></div>\n              </div>\n              <!--end today min-temp -->\n          </div>\n\n          <div class=\"today_cloud_percent\">\n              <!--start today min-temp -->\n              <div class=\"today_cloud_percent_icon\"><img src=\"https://thecreativecloud.co.za/icons/cloud_percent_on_yellow.svg\" alt=\"iweather\"></div>\n              <div class=\"today_cloud_percent_number\"><p>").concat(today.clouds, "</p></div>\n              <div class=\"today_cloud_percent_measure_and_title\">\n                  <div class=\"today_measure_symbol_and_letter\"><p>%</p></div>\n                  <div class=\"today_min_temp_title\"><p>Cloud</p></div>\n              </div>\n              <!--end today min-temp -->\n          </div>\n\n          <!--end today feature | min-temp | max-temp | Cloud %-->\n      </div>\n  <!--end today provision-->\n  "); //display tomorrow weather

  tomorrowContainer.innerHTML = "\n            <!--start tomorrow block-->\n                <div class=\"tomorrow_left_and_right_section_wrapper\">\n                    <!--tomorrow left and right section wrapper-->\n                    <div class=\"tomorrow_left_section\">\n                        <!--start tomorrow left section -->\n                        <div class=\"tomorrow_title\">\n                            <p>".concat(translatedText.text[1], "</p>\n                        </div>\n                        <div class=\"tomorrow_measure\">\n                            <div class=\"tomorrow_number\">\n                                <p>").concat(converNumber(tomorrow.temp), "</p>\n                            </div>\n                            <div class=\"tomorrow_symbol_and_degree\">\n                                <p class=\"symbol\">o</p>\n                                <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                            </div>\n                        </div>\n                        <!--end tomorrow left section /-->\n                    </div>\n                    \n                    <div class=\"tomorrow_right_section\">\n                        <!--start tomorrow right section -->\n                        <div class=\"tomorrow_max_min_temp_cloud\">\n\n                            <div class=\"tomorrow_max_temp\">\n                                <div class=\"tomorrow_max_icon\"><img src=\"https://thecreativecloud.co.za/icons/max_temp_gray.svg\" alt=\"\"></div>\n                                <div class=\"tomorrow_max_temp_number\"><p>").concat(converNumber(tomorrow.max_temp), "</p></div>\n                                <div class=\"tomorrow_max_temp_symbol_degree_and_title\">\n                                    <div class=\"tomorrow_max_temp_symbol\">\n                                        <p class=\"symbol\">o</p>\n                                        <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                                    </div>\n                                    <div class=\"tomorrow_max_title\"><p>Max-Temp</p></div>\n                                </div>\n                            </div>\n\n                            <div class=\"tomorrow_min_temp\">\n                                <div class=\"tomorrow_min_icon\"><img src=\"https://thecreativecloud.co.za/icons/min_temp_gray.svg\" alt=\"\"></div>\n                                <div class=\"tomorrow_min_temp_number\"><p>").concat(converNumber(tomorrow.min_temp), "</p></div>\n                                <div class=\"tomorrow_min_temp_symbol_degree_and_title\">\n                                    <div class=\"tomorrow_min_temp_symbol\">\n                                        <p class=\"symbol\">o</p>\n                                        <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                                    </div>\n                                    <div class=\"tomorrow_min_title\"><p>Min-Temp</p></div>\n                                </div>\n                            </div>\n\n                            <div class=\"tomorrow_cloud\">\n                                <div class=\"tomorrow_cloud_icon\"><img src=\"https://thecreativecloud.co.za/icons/cloud_gray.svg\" alt=\"\"></div>\n                                <div class=\"tomorrow_cloud_number\"><p>").concat(tomorrow.clouds, "</p></div>\n                                <div class=\"tomorrow_cloud_symbol_degree_and_title\">\n                                    <div class=\"tomorrow_cloud_symbol\"><p>%</p></div>\n                                    <div class=\"tomorrow_min_title\"><p>Cloud</p></div>\n                                </div>\n                            </div>\n\n                        </div>\n                        <!--end tomorrow right section /-->\n                    </div>\n                    <!--end tomorrow left and right section wrapper-->\n                </div>\n\n                <div class=\"tomorrow_date_and_overcast\">\n                    <p>").concat(formatDate(tomorrow.datetime, _objectdata.months), ", ").concat(tomorrow.weather.description, "</p>\n                </div>\n\n                <!--end tomorrow block-->\n  ");
  nextTwoDaysContainer.innerHTML = "\n\n            <div class=\"next_two_days_left following\">\n            <div class=\"next_two_days_left_overcast_title\"><p>".concat(cropString(thirdDay.weather.description), "</p></div>\n            <div class=\"next_two_days_left_date\"><p>").concat(formatDate(thirdDay.datetime, _objectdata.months), "</p></div>\n            <div class=\"next_two_days_left_degree_symbol\">\n                <div class=\"next_two_days_left_degree_number\"><p>").concat(converNumber(thirdDay.temp), "</p></div>\n                <div class=\"next_two_days_left_degree_symbol\">\n                    <p class=\"symbol\">o</p>\n                    <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                </div>\n            </div>\n            <div class=\"next_two_days_left_open_button\"><button class=\"open_button\" data-id=\"2\">").concat(translatedText.text[3], "</button></div>\n        </div>\n\n        <div class=\"next_two_days_right following\">\n            <div class=\"next_two_days_right_overcast_title\"><p>").concat(cropString(fourthDay.weather.description), "</p></div>\n            <div class=\"next_two_days_right_date\"><p>").concat(formatDate(fourthDay.datetime, _objectdata.months), "</p></div>\n            <div class=\"next_two_days_right_degree_symbol\">\n                <div class=\"next_two_days_right_degree_number\"><p>").concat(converNumber(fourthDay.temp), "</p></div>\n                <div class=\"next_two_days_right_degree_symbol\">\n                    <p class=\"symbol\">o</p>\n                    <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                </div>\n            </div>\n            <div class=\"next_two_days_right_open_button\"><button class=\"open_button\" data-id=\"3\">").concat(translatedText.text[3], "</button></div>\n        </div>\n  \n  "); // display 8 next days

  nextHeightDaysContainer.innerHTML = nextHeightDays.map(function (day) {
    return "\n\n          <div data-id=\"".concat(nextHeightDays.indexOf(day), "\" class=\"next_8days_block following\">\n              <div class=\"next_8days_block_title\"><p class=\"top_title\">").concat(formatDate(day.datetime, _objectdata.months), "</p></div>\n              <div class=\"next_8days_block_icon\"><img src=\"https://raw.githubusercontent.com/Ephrey/icon/master/").concat(day.weather.icon, ".png\" alt=\"\"></div>\n              <div class=\"next_8days_block_temperature_symbol_title\">\n                  <div class=\"next_8days_block_temperature_number\"><p>").concat(converNumber(day.temp), "</p></div>\n\n                  <div class=\"next_8days_block_symbol_and_title\">\n                      <div class=\"next_8days_block_temperature_symbol\">\n                          <p class=\"symbol\">o</p>\n                          <p class=\"degree\">").concat(_objectdata.defaultParameters.unit, "</p>\n                      </div>\n                      <div class=\"next_8days_block_title\"><p>Temperat.</p></div>\n                  </div>\n              </div>\n          </div>\n\n      ");
  }).join("");
  setTimeout(function () {
    handleHidden(authorisationMainContainer);
  }, 1200);
  setTimeout(function () {
    authorisationMainContainer.style.zIndex = -9999999999; // select all 8 days blocks

    var allNextDaysBlocks = document.querySelectorAll(".next_8days_block"); // select all open buttons   weatherData

    var openButtons = document.querySelectorAll(".open_button"); // add click event to all 8 days blocks container

    allNextDaysBlocks.forEach(function (block) {
      return block.addEventListener("click", displaySingleView);
    }); // add click event to all open button

    openButtons.forEach(function (button) {
      return button.addEventListener("click", displaySingleView);
    });
  }, 3000);
...
function displaySingleView() {
  ...
  var elementClickedId = this.dataset.id; // get the object from the 8 days array object that correspond to the cliked element
...
if (handleGetStorageData("userAutho")) {
  if (handleGetStorageData("userAutho").status) {
    ...
    setUserDefaultParameter(); // call the function that fech the data from APIs
...
},{"@glidejs/glide":"node_modules/@glidejs/glide/dist/glide.esm.js","fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js","../components/greettheuser":"components/greettheuser.js","../components/objectdata":"components/objectdata.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
